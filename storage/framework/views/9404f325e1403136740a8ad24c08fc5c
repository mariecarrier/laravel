    ...
    <div class="wrapper">
        ...
        <section class="inner-intro bg-img2 overlay-light parallax parallax-background2">
            <div class="container">
              ...
              <h1>Les 6 et 7 septembre 2015</h1>
              <p>au Montmartre,Centre de culture et foi à Québec</p>
              <p class="bouton"><a class="btn btn-lg btn-primary" href="#" role="button">Je m'inscris</a></p>             </div>
                ...
                <div class="row">
                 ...
                 <div class="wrapper-box">
                    <div class="col-md-6">
                        ...
                        <p class="lead photo-invite"><img src="img2/jean-yves-leloup.jpg"></p>
                    </div>
                    <div class="col-md-6">
                        ...
                        <h3>Le corps, don grâce et épreuve</h3>
                    
                        <p>Explorer les dimensions psychologiques et spirituelles du corps afin d'apporter un éclairage sur la diversité des approches et des expériences de nos contemporains, tel est le but fixé par l'équipe organisatrice de la deuxième édition des Assises de la Spiritualité. Pendant deux jours, autour de Jean-Yves Leloup qui nous aidera à cheminer dans cette démarche et, à travers des ateliers, des intervenants expérimentés nous ferons partager leur expérience...</p>
        ...
        <section class="ptb ptb-sm-80">
            <div class="wow fadeIn container text-center">
                ...
                <div class="row">
                    <div class="col-md-3 assomption">
                        <img src="img2/logos/logo-assomption.jpg">
                    </div>
                    <div class="col-md-3 medias-paul">
                      <img src="img2/logos/logo-medias-paul.jpg">
                    </div>
                    <div class="col-md-3 montmartre">
                       <img src="img2/logos/logo-montmartre.jpg">
                    </div>
                    <div class="col-md-3 novalis">
                       <img src="img2/logos/logo-novalis.jpg">
                    </div>
                </div>
            </div>
        </section>
        ...
        <footer class="footer pt-80">
                ...
                <div class="row mb-60">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12 mb-xs-30">
                        <a class="footer-logo" href="home.html">
                            <img src="img2/logo-novalis.svg" /></a>
                            <p style="text-align:center; line-height: 1.5em; float:left; font-size:12px;   margin-top: 5px;">Une présentation<br>de Novalis Canada.</p>
                    </div>
                    <!-- Logo -->
            ...
            <section class="copyright ptb-60">
                <div class="container">
                    <p class="">
                        © 2015 <a><b>Novalis Canada</b></a>. Tous droits réservés.
                        <br />
