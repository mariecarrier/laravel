...
<!-- Sidemenu -->
<section class="side-menu cbp-spmenu cbp-spmenu-vertical cbp-spmenu-right"> <a class="menu-close toggle-menu menu-right push-body"><i class="ion ion-android-close"></i></a>
...
<header class="header">
    <div class="container"> 
        ...
        <nav class='navigation'>
            <ul>
                <li> <a href="/assises1.html">Accueil</a> </li>
                <li class="nav-has-sub"> <a href="/details.html" target="_parent">Détails</a> 
                    <!-- Nav Dropdown --> 
                    
                    <!-- End Nav Dropdown--> 
                </li>
                <li> <a href="/inscription.html" target="_parent">Inscription</a> 
                    <!-- Nav Dropdown --> 
                    
                    <!-- End Nav Dropdown --> 
                </li>
                <li> <a href="/contactez-nous.html" target="_parent">Contactez-nous</a> 
                    <!-- Nav Dropdown --> 
...
<!-- Intro Section -->
<section class="inner-intro sub-pages bg-img2 overlay-light parallax parallax-background2">
    <div class="container">
...
<div class="row">
    <div class="wrapper-box2">
        <div class="col-md-10">
            ...
            <div class="participants">
             ...
             <!-- Début participant unique -->   
             <div class="participants-uniques">
            ...
            <div class="inscription">
                ...
                <div style="clear:both"></div>
                   <p class="wrapper-input infolettre">
                    <label for="infolettre">Recevez nos communiqués électroniques</label>
                    <br>
                <form action="">
    ...
    <section class="ptb ptb-sm-80">
        <div class="wow fadeIn container text-center">
            ...
            <div class="row">
                <div class="col-md-3 assomption"> <img src="img2/logos/logo-assomption.jpg"> </div>
                <div class="col-md-3 medias-paul"> <img src="img2/logos/logo-medias-paul.jpg"> </div>
                <div class="col-md-3 montmartre"> <img src="img2/logos/logo-montmartre.jpg"> </div>
                <div class="col-md-3 novalis"> <img src="img2/logos/logo-novalis.jpg"> </div>
            </div>
        </div>
    </section>
    <!-- End Service -->
    ...
    <footer class="footer pt-80">
        <div class="container">
            <div class="row mb-60"> 
                <!-- Logo -->
                <div class="col-md-3 col-sm-3 col-xs-12 mb-xs-30"> <a class="footer-logo" href="home.html"> <img src="img2/logo-novalis.svg" /></a>
                    <p style="text-align:center; line-height: 1.5em; float:left; font-size:12px;   margin-top: 5px;">Une présentation<br>
                        de Novalis Canada.</p>
                </div>
                <!-- Logo --> 
                
                <!-- Newsletter -->
                <div class="col-md-4 col-sm-5 col-xs-12 mb-xs-30"> </div>
                <!-- End Newsletter --> 
                
                <!-- Social -->
                <div class="col-md-3 col-md-offset-2 col-sm-4 col-xs-12">
                    <ul class="social" style="margin: 20px 0px; text-align:right;">
                        <li><a target="_blank" href="https://www.twitter.com/"><i class="fa fa-twitter"></i></a></li>
                        <li><a target="_blank" href="https://www.facebook.com/"><i class="fa fa-facebook"></i></a></li>
                    </ul>
                    <ul class="link-small" style="margin: 20px 0px; text-align:right;">
                        <li><a href="mailto:sac@novalis"><i class="fa fa-envelope-o left"></i>sac@novalis</a></li>
                        <li><a><i class="fa fa-phone left"></i>1 800 668-2547</a></li>
                    </ul>
                </div>
                <!-- End Social --> 
            </div>
        ...
        <section class="copyright ptb-60">
            <div class="container">
                <p class=""> © 2015 <a><b>Novalis Canada</b></a>. Tous droits réservés. <br />
                </p>
            </div>
        </section>
        <!-- End Copyright Bar --> 
